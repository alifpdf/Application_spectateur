error id: 4FCF538BDA2BCB9F08A49BDB7C65F7F4
  ...
  def update(model: Model): Msg => (Model, Cmd[IO, Msg]) =
    {
      ...
      case Msg.Bluetooth(BluetoothMsg.NotificationReceived(txt)) =>
        ...
        // Extraction de la/dernière position POS r c du lot
...
scala.runtime.Scala3RunTime$.assertFailed(Scala3RunTime.scala:11)
	...
	dotty.tools.dotc.core.Types$OrType.join(Types.scala:3611)
	dotty.tools.dotc.core.Types$Type.goOr$1(Types.scala:988)
	dotty.tools.dotc.core.Types$Type.go$1(Types.scala:849)
	dotty.tools.dotc.core.Types$Type.findMember(Types.scala:1004)
	dotty.tools.dotc.core.Types$Type.memberBasedOnFlags(Types.scala:786)
	dotty.tools.dotc.core.Types$Type.member(Types.scala:770)
	dotty.tools.dotc.typer.ProtoTypes$SelectionProto.isMatchedBy(ProtoTypes.scala:245)
	...
	dotty.tools.dotc.core.TypeComparer.testSubType(TypeComparer.scala:160)
	dotty.tools.dotc.core.TypeComparer$.testSubType(TypeComparer.scala:3440)
	dotty.tools.dotc.typer.Typer.adaptNoArgsOther$1(Typer.scala:4648)
	dotty.tools.dotc.typer.Typer.adaptNoArgs$1(Typer.scala:4735)
	dotty.tools.dotc.typer.Typer.adapt1(Typer.scala:4998)
	...
	dotty.tools.dotc.typer.Applications.harmonic(Applications.scala:2738)
	...
	dotty.tools.dotc.typer.Typer.typed(Typer.scala:3836)
	dotty.tools.dotc.typer.Typer.typed(Typer.scala:3841)
	dotty.tools.dotc.typer.Typer.typedMatch(Typer.scala:2111)
	dotty.tools.dotc.typer.Typer.typedUnnamed$1(Typer.scala:3686)
	dotty.tools.dotc.typer.Typer.typedUnadapted(Typer.scala:3759)
	...
	dotty.tools.dotc.typer.Applications$ApplyToUntyped.typedArg(Applications.scala:1065)
	dotty.tools.dotc.typer.Applications$ApplyToUntyped.typedArg(Applications.scala:1065)
	dotty.tools.dotc.typer.Applications$Application.addTyped$1(Applications.scala:731)
	dotty.tools.dotc.typer.Applications$Application.matchArgs(Applications.scala:814)
	dotty.tools.dotc.typer.Applications$Application.init(Applications.scala:610)
	dotty.tools.dotc.typer.Applications$TypedApply.<init>(Applications.scala:940)
	dotty.tools.dotc.typer.Applications$ApplyToUntyped.<init>(Applications.scala:1064)
	dotty.tools.dotc.typer.Applications.ApplyTo(Applications.scala:1362)
	dotty.tools.dotc.typer.Applications.ApplyTo$(Applications.scala:470)
	dotty.tools.dotc.typer.Typer.ApplyTo(Typer.scala:155)
	dotty.tools.dotc.typer.Applications.simpleApply$1(Applications.scala:1152)
	dotty.tools.dotc.typer.Applications.$anonfun$15(Applications.scala:1268)
	dotty.tools.dotc.typer.Typer$.tryEither(Typer.scala:128)
	dotty.tools.dotc.typer.Applications.realApply$1(Applications.scala:1287)
	dotty.tools.dotc.typer.Applications.typedApply(Applications.scala:1336)
	dotty.tools.dotc.typer.Applications.typedApply$(Applications.scala:470)
	dotty.tools.dotc.typer.Typer.typedApply(Typer.scala:155)
	dotty.tools.dotc.typer.Typer.typedUnnamed$1(Typer.scala:3671)
	...
	dotty.tools.dotc.typer.Typer.typed(Typer.scala:3841)
	dotty.tools.dotc.typer.Typer.typedExpr(Typer.scala:3952)
	dotty.tools.dotc.typer.Typer.typedValDef(Typer.scala:2968)
	dotty.tools.dotc.typer.Typer.typedNamed$1(Typer.scala:3650)
	dotty.tools.dotc.typer.Typer.typedUnadapted(Typer.scala:3758)
	dotty.tools.dotc.typer.Typer.typed(Typer.scala:3836)
	dotty.tools.dotc.typer.Typer.typed(Typer.scala:3841)
	dotty.tools.dotc.typer.Typer.traverse$1(Typer.scala:3863)
	...
	dotty.tools.dotc.typer.Typer.typedCases(Typer.scala:2246)
	dotty.tools.dotc.typer.Typer.$anonfun$41(Typer.scala:2229)
	dotty.tools.dotc.typer.Applications.harmonic(Applications.scala:2743)
	dotty.tools.dotc.typer.Applications.harmonic$(Applications.scala:470)
	dotty.tools.dotc.typer.Typer.harmonic(Typer.scala:155)
	dotty.tools.dotc.typer.Typer.typedMatchFinish(Typer.scala:2229)
	dotty.tools.dotc.typer.Typer.typedMatch(Typer.scala:2157)
	...
	dotty.tools.dotc.typer.Typer.typed(Typer.scala:3841)
	dotty.tools.dotc.typer.Typer.typedExpr(Typer.scala:3952)
	dotty.tools.dotc.typer.Typer.$anonfun$68(Typer.scala:3028)
	dotty.tools.dotc.inlines.PrepareInlineable$.dropInlineIfError(PrepareInlineable.scala:256)
	dotty.tools.dotc.typer.Typer.typedDefDef(Typer.scala:3028)
	dotty.tools.dotc.typer.Typer.typedNamed$1(Typer.scala:3653)
	dotty.tools.dotc.typer.Typer.typedUnadapted(Typer.scala:3758)
	dotty.tools.dotc.typer.Typer.typed(Typer.scala:3836)
	dotty.tools.dotc.typer.Typer.typed(Typer.scala:3841)
	dotty.tools.dotc.typer.Typer.traverse$1(Typer.scala:3863)
