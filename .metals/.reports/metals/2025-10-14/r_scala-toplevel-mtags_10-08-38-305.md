error id: file://<WORKSPACE>/build.mill:[1084..1091) in Input.VirtualFile("file://<WORKSPACE>/build.mill", "import mill.*, scalalib.*, scalajslib.*
...
file://<WORKSPACE>/build.mill:49: error: expected identifier; obtained package
  def package
      ^
#### Short summary: 
